 ...
 * @param {string} [opts.deadlineText] e.g. "August 12, 2026 at 5:00 PM" (48h window)
 * @param {string[]} [opts.sets]       e.g. ["Living Room Set", "Dining Set"]
 */
export function inspectionHtml({ name, inspectionUrl, deadlineText, sets }) {
  ...
  const deadlineBlock = deadlineText
            ...
            <tr>
              <td style="padding: 16px 20px; text-align: center;">
                <p style="margin: 0 0 4px; font-family: 'League Spartan', Arial, sans-serif; font-size: 14px; font-weight: 400; color: #816F68; line-height: 1.5;">
                  You have 48 hours to report any missing items, major damage, or assembly issues.
                </p>
                <p style="margin: 0; font-family: 'Manrope', Arial, sans-serif; font-size: 14px; font-weight: 600; color: #865651; line-height: 1.5;">
                  Report issues by ${esc(deadlineText)}
                </p>
              </td>
            </tr>
          </table>
    ...
    : `<tr>
        <td class="email-deadline-pad" style="padding: 0 48px 28px; text-align: center;">
          <p style="margin: 0; font-family: 'League Spartan', Arial, sans-serif; font-size: 14px; font-weight: 400; color: #865651; line-height: 1.5;">
            You have 48 hours to report any missing items, major damage, or assembly issues.
          </p>
        </td>
      </tr>`;
