        ...
        <table class="email-wrap" cellpadding="0" cellspacing="0" border="0" bgcolor="#F9F5F1" style="width: 100%; max-width: 600px;">
          ...
          <tr>
            <td class="email-hero-pad" style="padding: 0 32px 28px;">
              <img src="https://checkout.roomonyc.com/email/welcome-illustration.jpg" alt="Curated Living, Delivered." width="536" style="width: 100%; height: auto; display: block; border-radius: 10px;" />
            </td>
          </tr>
